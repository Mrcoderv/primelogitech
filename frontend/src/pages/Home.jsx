...
export default function Home() {
  ...
  return (
    <div className="w-full">
      <section className="relative pt-24 sm:pt-28 lg:pt-48 pb-16 sm:pb-20 lg:pb-32 overflow-hidden">
        <div className="absolute top-16 sm:top-20 left-1/2 -translate-x-1/2 w-[320px] sm:w-[800px] h-[220px] sm:h-[400px] bg-brand-blue/30 blur-[90px] sm:blur-[120px] rounded-full pointer-events-none" />
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center max-w-5xl mx-auto">
            <motion.div
              ...
              className="relative inline-flex items-center justify-center mb-4 sm:mb-6 lg:mb-8 px-4"
            >
              <BrandLogo size="xxl" eager className="h-28 w-28 sm:h-40 sm:w-40 md:h-52 md:w-52 lg:h-60 lg:w-60 drop-shadow-[0_0_32px_rgba(18,146,255,0.45)]" />
            </motion.div>
            ...
            <motion.div
              ...
              className="mb-6 sm:mb-8 text-xs sm:text-sm md:text-base uppercase tracking-[0.25em] sm:tracking-[0.45em] text-brand-green/80"
            >
            ...
            <motion.div
              ...
              animate={{ opacity: 1, y: 0 }}
              transition={{ duration: 0.5 }}
              className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-white/5 border border-white/10 text-xs sm:text-sm text-brand-blue mb-6 sm:mb-8"
            >
            ...
            <motion.h1
              ...
              className="text-3xl sm:text-5xl md:text-7xl font-bold mb-6 sm:mb-8 leading-tight tracking-tight"
            >
            ...
            <motion.p
              ...
              className="text-base sm:text-lg md:text-xl text-gray-400 mb-8 sm:mb-10 max-w-2xl mx-auto px-2 sm:px-0"
            >
            ...
            >
              <Link
                to="/contact"
                className="bg-white text-black px-8 py-4 rounded-xl font-medium hover:bg-gray-100 transition-colors inline-flex items-center justify-center gap-2 group w-full sm:w-auto"
              >
                Start a Project
              ...
              <Link
                to="/portfolio"
                className="px-8 py-4 rounded-xl font-medium glass-panel hover:bg-white/10 transition-colors text-center w-full sm:w-auto"
              >
                View Our Work
              </Link>
            </motion.div>
      ...
      <section className="py-8 sm:py-10 border-y border-white/5 bg-white/[0.02]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <p className="text-center text-sm text-gray-500 mb-8 font-medium tracking-widest uppercase">
            Trusted by innovative companies
          </p>
          <div className="flex flex-wrap justify-center items-center gap-6 sm:gap-10 md:gap-24 opacity-50 grayscale hover:grayscale-0 transition-all duration-500">
            <div className="text-lg sm:text-xl font-bold font-outfit">ACME Corp</div>
            <div className="text-lg sm:text-xl font-bold font-outfit">GlobalTech</div>
            <div className="text-lg sm:text-xl font-bold font-outfit">Nexus</div>
            <div className="text-lg sm:text-xl font-bold font-outfit">Stellar</div>
            <div className="text-lg sm:text-xl font-bold font-outfit">Quantum</div>
          </div>
        </div>
      </section>
      ...
      <section className="py-16 sm:py-20 lg:py-24 relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12 sm:mb-16">
            <h2 className="text-3xl sm:text-4xl md:text-5xl font-bold mb-4 sm:mb-6">Our Expertise</h2>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 sm:gap-12 lg:gap-16 items-center">
            ...
            <div className="relative mt-4 lg:mt-0">
              ...
              <div className="glass-panel p-6 sm:p-8 relative rounded-3xl overflow-hidden">
      ...
      <section className="py-16 sm:py-20 lg:py-24">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex flex-col md:flex-row justify-between items-start md:items-end mb-12 sm:mb-16 gap-6">
            ...
            <Link to="/portfolio" className="inline-flex items-center gap-2 text-brand-blue hover:text-white transition-colors font-medium w-full md:w-auto justify-center md:justify-start">
          ...
          <div className="relative rounded-[2rem] border border-white/10 bg-white/[0.03] overflow-hidden">
            <div className="flex items-center justify-between gap-3 px-4 pt-4 sm:px-6 sm:pt-6 md:px-8 md:pt-8">
              <button
                type="button"
            ...
            <div className="px-3 pb-3 pt-4 sm:px-4 sm:pb-4 sm:pt-6 md:px-6 md:pb-6">
